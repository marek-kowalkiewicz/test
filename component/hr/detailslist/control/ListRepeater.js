jQuery.sap.declare("mynewproject.component.hr.detailslist.control.ListRepeater");

/**
 * ListRepeater custom control. Used to repeat and render mobile lists.
 */
sap.ui.core.Control.extend("mynewproject.component.hr.detailslist.control.ListRepeater", {
