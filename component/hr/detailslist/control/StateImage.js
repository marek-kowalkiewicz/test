jQuery.sap.declare("mynewproject.component.hr.detailslist.control.StateImage");

/**
 * StateImage custom control. Displays icons based on a state.
 */
sap.ui.core.Control.extend("mynewproject.component.hr.detailslist.control.StateImage", {
