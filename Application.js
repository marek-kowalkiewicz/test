jQuery.sap.declare("mynewproject.Application");
jQuery.sap.require("sap.ui.core.Application");

sap.ui.core.Application.extend("mynewproject.Application", {
	...
	setLocale : function(value) {
		...
		this._oI18nModel = new sap.ui.model.resource.ResourceModel({bundleName:"mynewproject.i18n.i18n", bundleLocale: this.getLocale()});
	...
	main : function() {
		if (!jQuery.device.is.tablet) {
			this._oView = sap.ui.htmlview("main", "mynewproject.Main");	
		} else {
