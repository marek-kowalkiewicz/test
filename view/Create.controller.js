 ...
 */
sap.ui.controller("mynewproject.view.Create", {
	 ...
	 */
	onInit : function() {
		this.byId("pageCreateFrom").bindProperty("value", {path: "create>/from", formatter: mynewproject.util.Types.DATE});
		this.byId("pageCreateTo").bindProperty("value", {path: "create>/to", formatter: mynewproject.util.Types.DATE});
	},
	...
	onCreate: function() {
		...
		oData.from = mynewproject.util.Types.DATE.formatValue(this._getDates().from, "string");
		oData.to = mynewproject.util.Types.DATE.formatValue(this._getDates().to, "string");
	 ...
	 */
	_getDates : function() {
		var oDateType = mynewproject.util.Types.DATE;
		return {
